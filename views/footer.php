...
<footer class="bg-white">
  <div class="mx-auto w-full container p-4 sm:p-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center">© 2023 <a href="#" class="hover:underline">@Alvarenga144™</a>. All Rights Reserved.
      </span>
...
<script src="<?= URL ?>public/js/navbarMenu.js"></script>
<!-- Bootstrap -->
