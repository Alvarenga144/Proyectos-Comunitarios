<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
    <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white md">
      <li>
        <a href="<?= URL ?>inicio/home" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">Home</a>
      </li>
      <li>
        <a href="<?= URL ?>gestionAcontecimiento/acontecimientos" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Events</a>
      </li>
      <li>
        <a href="<?= URL ?>Municipio/TablaMunicipios" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Municipalities</a>
      </li>
      <li>
        <a href="<?= URL ?>empleado/TablaEmpleados" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Employees</a>
      </li>
      <li>
        <a href="<?= URL ?>gestionUsuario/TablaUsuario" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Users</a>
      </li>
      <li>
        <a href="<?= URL ?>informe/pdfProyectos" class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Reports</a>
      </li>
    </ul>
  </div>
  <?php
