<nav class="bg-white border px-0 sm:px-4 py-2">
  <div class="container flex flex-wrap items-center justify-between mx-auto">
    ...
    ?>
        <div class="flex items-center md:order-2">
          <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300" id="user-menu-button-profile" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
          ...
          ?>
            <div class="hidden z-50 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow" id="user-dropdown-panel">
              <div class="px-4 py-3">
